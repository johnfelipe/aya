...
$query_acta=mysql_query("SELECT * FROM actas WHERE estado='cerrado'");
...
while($libro_row=mysql_fetch_array($query_acta))
{
...
AND nomina_consejo.nomina_conid=relacion_actas.relacion_nominaid AND nomina_consejo.nomina_id=relacion_actas.relacion_funcionario AND relacion_actas.relacion_actaid=$libro_row[act_id] ORDER BY cargo.rango, cargo.nivel");
