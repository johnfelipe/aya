				...
				while($row_acta=mysql_fetch_array($query_acuerdos))
				{
					...
					if($valida_repro >=1)
					{
						...
						while($row_table=mysql_fetch_array($q_tabla))
						{
							...
							switch ($case) 
								{
									case 0:
										$datas[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 1:
										$datas1[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 2:
										$datas2[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 3:
										$datas3[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 4:
										$datas4[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 5:
										$datas5[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 6:
										$datas6[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 7:
										$datas7[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 8:
										$datas8[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 9:
										$datas9[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 10:
										$datas10[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
									case 11:
										$datas11[] = array($bb,@$row_table['rep_a'],@$dato,@$row_table['rep_c'],@$row_table['rep_d'],$di);
									break;
								}
						...
						for($aa=0;$aa<=$fin; $aa++)
						{
							if($aa==0)
							{
								if($case==0)
								{
								 @$arr[]=' Acuerdo Número '.$text1.$partes[0];
								}
								else
								{
									$indice=sizeof($arr)-1;
					...
					else
					{
						...
						$indice=sizeof($arr)-1;
							...
							$arr[$indice].= ' Acuerdo Número '.$tex_acta." ";
						}
		...
		if(!($bb%2==0))
		{
			...
			else
			{
				$cordenadasY=$pdf->GetY();
				 ...
				 {
					$pdf->Ln(8);
					$pdf->multicell(65,3,utf8_decode($per)."\n".utf8_decode($genero),0,'C');
					$cordenadasY=$pdf->GetY();
				 }
				 else
				 {
