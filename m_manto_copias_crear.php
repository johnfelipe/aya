...
$nom_archivo = date('d-m-Y').'_'.$text1.'_'.$row['back_head'];
				...
				while (!feof($fd)) {///mientras no este en el final del documento leido
					...
					$buffer = fgets($fd, 1024);  //recorrera linea por linea asta una extencion 1024 caracteres
					
					//$pop=strrev($buffer);
					$rebuffer=convert_uuencode($buffer);
					fwrite($cryp,$rebuffer); //escribe y encryptada la linea leida
...
<div id="content">
    ...
    <div align="center" id="table1">
      ...
      <table width="70%" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2  >Crear Copia de Seguridad</h2></td>
          </tr>
        <tr>
