...
<div id="menus">
    ...
    <li id="active"><a href="m.mantenimiento.php">mantenimineto</a></li>
...
<table width="85%" border="0" cellspacing="5" align="center">
  <tr>
    ...
    <td align="center"><h2 style="color: #5B920A;">Impresión de Bitacora </h2></td>
  </tr>
  <tr>
    <td align="center">
...
if(isset($buscar))
{
			...
			//fin fecha
				...
				if(mysql_num_rows($consul) > 0)
				{
					...
					echo " <table border='0' cellspacing=\"0\" width=\"60 %\" >
						<tr>
							<th>Fecha&nbsp;</th>
							<th>&nbsp;</th>
							<th>Descripción</th>
