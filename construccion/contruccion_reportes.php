...
if(isset($guardar))
{
	...
	echo $h1."_".$par0[1]."_".$par1[1]."_".$text4;
		...
		if(mysql_query("INSERT INTO nomina_consejo VALUES('',$h1,$par0[1],$par1[1],1,'$text4')"))
		{
...
<div id="menus">
    ...
    <li><a href="m_mantenimiento.php">mantenimineto</a></li>
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><img src="img/construccion info tech.png" /></td>
