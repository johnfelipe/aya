...
<div id="menus">
    ...
    <li id="active"><a href="m_mantenimiento.php">Mantenimineto</a></li>
...
<div align="center">
  ...
  <table width="75%" border="0" cellspacing="5" align="center">
    <tr>
      ...
      <td align="center"><h2 >Registro del Municipios</h2></td>
      </tr>
    
    <tr>
      <td align="center">
        <form method="post" enctype="application/x-www-form-urlencoded" name="re_municipio" action="registro/procesa_muni.php">
          <table width="50%" border="0" cellspacing="5">
            <tr>
              <th scope="row">Departamento</th>
              <td><span id="sprytextfield1">
                <label for="text1"></label>
                <input type="text" name="text1" id="text1" / readonly="readonly" onclick="open('consultas/ges_depa.php?id=text1','per', 'width=900 ,height=700');"  style="cursor:pointer" >
            ...
            <tr>
              <th colspan="2" scope="row"><input type="submit" name="guardar" value="Guardar"  />
