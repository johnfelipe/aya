...
<body>
    ...
    <h2 align="center">Nomina de Asistencia del Concejo Municipal</h2>
    <table>
				...
				while(@$row2=$paging->fetchResultado())
				{
					...
					if($numero%2==0)
					{
						echo"<tr align=center bgcolor='#BDBDBD'>
								...
								<td><input type=\"button\" nane='bx' value=\"+\"  onclick=\"open('../consultas/lista_asis.php?id_acta=$id_acta&id_conse=$row2[per_consejo_id]&nomina_id=$row2[nomina_id]&id_cargo=$row2[car_id]&cargo_nom=$row2[car_m]&id_per=$row2[id_persona]&nombre_per=$row2[nombres]&ape_per=$row2[primer_apellido]','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" >";
					}
					else
					{
						echo"<tr align=center >
								...
								<td><font ><input type=\"button\" nane='bx' value=\"+\"onclick=\"open('../consultas/lista_asis.php?id_acta=$id_acta&id_conse=$row2[per_consejo_id]&nomina_id=$row2[nomina_id]&id_cargo=$row2[car_id]&cargo_nom=$row2[car_m]&id_per=$row2[id_persona]&nombre_per=$row2[nombres]&ape_per=$row2[primer_apellido]','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" ></font></td>
							</tr>";
