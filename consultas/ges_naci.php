        	...
        	<td >
            	<fieldset >
                  ...
                  <form method="GET" name="pero_conesjo">
                    ...
                    <tr>
                      <td rowspan="2">Busqueda de Nacionalidad</td>
...
$mensaje="";
	...
	if(@$_GET['buscar'])
	{
		...
		//trado de los apellidos
			...
			$query="SELECT * FROM nacionalidades WHERE descripcion like'%$c1%'"; //query por defaul
				...
				if(mysql_num_rows($consul)>0)
				{
					...
					while($f= $paging->fetchResultado()) 
					{
								...
								echo "<tr align=center bgcolor='#BDBDBD'>
										...
										<td><font color='white'><input type=\"button\" nane='bx' value=\"+\" onClick=\"opener.document.getElementById('text8').value='$f[descripcion]+$f[id_nacionalidad]\\n';window.close();\" style='cursor:pointer'></font></td>
									</tr>";
								}
								else
								{
									echo "<tr align=center>
											<td>". $f['descripcion']."</td>
											<td><input type=\"button\" nane='bx' value=\"+\" onClick=\"opener.document.getElementById('text8').value='$f[descripcion]+$f[id_nacionalidad]\\n';window.close();\" style='cursor:pointer'></font></td>
										</tr>";
