...
<title>Nomina Edición de Reprogramacion</title>
</head>
			...
			if($existe_cc > 0)
			{
				...
				while($row2=$paging->fetchResultado())
				{
						...
						echo"<tr align=center bgcolor='#BDBDBD'>
								...
								<td><input type=\"button\" nane='bx' value=\"editar\"  onclick=\"open('../consultas/editar_repro_datos.php?id=".$row2['rep_id']."','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" >";
							}
							else
							{
								echo"<tr align=center >
										...
										<td><font ><input type=\"button\" nane='bx' value=\"editar\"onclick=\"open('editar_repro_datos.php?id=".$row2['rep_id']."','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" ></font></td>
									</tr>";
