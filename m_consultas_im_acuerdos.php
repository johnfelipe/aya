...
<div id="menus">
   ...
   <li><a href="#">salir</a></li>
    ...
    <li><a href="#">Impresion de Acuerdos</a></li>
...
<table width="85%" border="0" cellspacing="5" align="center">
  <tr>
    ...
    <td align="center"><h2  >Impresión de Acuerdos</h2></td>
  </tr>
  <tr>
    <td align="center">
...
if(isset($buscar))
{
			...
			//funciones
				...
				if(!empty($c1))
				{
					$query="SELECT actas.act_num, actas.act_id, actas.act_fecha, acuerdos.acu_num, acuerdos.acu_id, acuerdos.acu_desc  FROM  actas, acuerdos WHERE actas.act_id=acuerdos.acu_actid AND actas.act_num LIKE '%$c1%'"; //query por defaul
				}
				else
				{
			...
			//fin fecha
				...
				if(mysql_num_rows($consul) > 0)
				{
					...
					echo " <table border='1' cellspacing=\"2\" width=\"680 px\" >
						<tr>
							<th>N&deg; de acta&nbsp;</th>
							<th>&nbsp;N&deg; de acuerdo&nbsp;</th>
							<th>&nbsp;&nbsp;Fecha de realizacion&nbsp;&nbsp;</th>
							<th>Descripcion&nbsp;&nbsp;</th>
							<th width='150 px'> Impresión Acuerdos</th>
						...
						$valida=mysql_fetch_array($activa);
							...
							$date_leer=$date_p['2'].'-'.$date_p['1'].'-'.$date_p['0'];
								...
								echo "<tr align=center bgcolor='#BDBDBD'>
										...
										<td><font color='white'>&nbsp;<a href=\"impresiones/acuerdo_pdf.php?id_acu_pdf=".$f['acu_id']."&acta=".$f['act_id']."\" target=\"_new\" ><img src='./img/membre.png' width='25 px'></a> <a href=\"impresiones/acuerdo_tradi_pdf.php?id_acu_pdf=".$f['acu_id']."&acta=".$f['act_id']."\" target=\"_new\" ><img src='./img/trad.png' width='25 px'></a> 
										</a> <a href=\"impresiones/acuerdo_pdf_secretario.php?id_acu_pdf=".$f['acu_id']."&acta=".$f['act_id']."\" target=\"_new\" ><img src='./img/cert.png' width='25 px'></a>
										<a href=\"impresiones/acuerdo_pdf_secretario_t.php?id_acu_pdf=".$f['acu_id']."&acta=".$f['act_id']."\" target=\"_new\" ><img src='./img/trad.png' width='25 px'></a></td>
