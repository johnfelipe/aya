...
<div id="menus">
   ...
   <li><a href="#">salir</a></li>
    ...
    <li><a href="#">Impresion Actas</a></li>
...
<table width="85%" border="0" cellspacing="5" align="center">
  <tr>
    ...
    <td align="center"><h2  >Impresión de Actas </h2></td>
  </tr>
  <tr>
    <td align="center">
...
if(isset($buscar))
{
			...
			if(!empty($c1))
			{
				$query="SELECT actas.act_id, actas.act_conid, actas.act_num, actas.act_fecha, actas.act_type FROM actas WHERE actas.act_num LIKE '%$c1%'  ORDER BY  actas.act_id, actas.act_num"; //query por defaul
			}
			else
			{
				$query="SELECT actas.act_id, actas.act_conid, actas.act_num, actas.act_fecha, actas.act_type FROM per_consejo, actas WHERE actas.act_num LIKE '%$c1%' AND per_consejo.per_consejo_id=actas.act_conid AND per_consejo.per_activo=1  ORDER BY  actas.act_id, actas.act_num"; //query por defaul #2
			}
						...
						$valida=mysql_fetch_array($activa);
							...
							$date_leer=$date_p['2'].'-'.$date_p['1'].'-'.$date_p['0'];
								...
								echo "<tr align=center bgcolor='#BDBDBD'>
										...
										<td><font color='white'>&nbsp;<a href=\"impresiones/actas_pdf.php?id=".$f['act_id']."&type=".$f['act_type']."\" target=\"_new\" ><img src=\"img/actas.png\" width=\"60 px\" alt=\"Imprime Acta\" title=\"Imprime Acta\"></a> </td>
										<td><font color='white'>&nbsp;<a href=\"m_consultas_im_ac_quest.php?id=".$f['act_id']."&type=".$f['act_type']."\" target=\"_self\" ><img src=\"img/acuerdos.png\" width=\"60 px\" title=\"Imprime Acuerdos\" ></a> </td>
									</tr>";
								}
								else
								{
									echo "<tr align=center>
											<td>".$f['act_num']."</td>
											<td>".$date_leer."</td>
											<td><font color='white'>&nbsp;<a href=\"impresiones/actas_pdf.php?id=".$f['act_id']."&type=".$f['act_type']."\" target=\"_new\" ><img src=\"img/actas.png\" width=\"60 px\" alt=\"Imprimie Acta\" title=\"Imprime Acta\"></a> </td>
											<td><font color='white'>&nbsp;<a href=\"m_consultas_im_ac_quest.php?id=".$f['act_id']."&type=".$f['act_type']."\" target=\"_self\" ><img src=\"img/acuerdos.png\" width=\"60 px\" title=\"Imprime Acuerdos\" ></a> </td>
