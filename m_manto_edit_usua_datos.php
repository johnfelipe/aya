...
$query_usu=mysql_query("SELECT * FROM usuarios WHERE usu_id=$id");
$row_usu=mysql_fetch_array($query_usu);
$query_perso=mysql_query("SELECT personas.nombres, personas.primer_apellido  FROM personas, empleados WHERE personas.id_persona=empleados.emp_perid AND empleados.emp_id=$row_usu[usu_eid]");
$row_per=mysql_fetch_array($query_perso);
...
<div id="content">
    ...
    <div align="center" id="table1">
    	<div align="center">
      <table width="200" border="0" cellspacing="5" align="center">
        <tr>
        ...
        <tr>
          <td align="center">
            <form name="principal" method="post" enctype="multipart/form-data" action="registro/update_usuarios.php" >
              <table width="328" border="0" cellspacing="5">
                <tr>
                  <th width="82" scope="row">Empleado<input type="hidden" name="h1" value="<?php echo $id; ?>" /></th>
                  <td width="227"><span id="sprytextfield2">
                  <label for="text1"></label>
                  <input name="text1" type="text" class="textareaFocusState" id="text1" maxlength="80" readonly="readonly" value="<?php  echo $row_per['nombres'].' '.$row_per['primer_apellido'];?>"  />
                ...
                <tr>
                  ...
                  <td><span id="sprytextfield3">
                    ...
                    <input type="text" name="text2" id="text2" maxlength="33" value="<?php echo $row_usu['usu_usu']  ?>"/>
                    <span class="textfieldRequiredMsg">*</span></span></td>
                ...
                <tr>
                  ...
                  <td><span id="spryselect1">
                    ...
                    <option value="0">-elija-</option>
                      <?php  
					  if($row_usu['usu_tip']=='u1')
					  {
						  echo "
						   <option value=\"u1\" selected=\"selected\">Digitador</option>
					 ...
					 else if($row_usu['usu_tip']=='u2')
					  {
						    echo "
					  <option value=\"u1\" >Digitador</option>
                      <option value=\"u2\" selected=\"selected\">Admnistrador</option>
					  <option value=\"root\">root</option>";
