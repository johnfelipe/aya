...
if(@$buscar)
{
			...
			$query="select actas.act_id, actas.act_conid, actas.act_num, actas.act_fecha, actas.act_type from per_consejo, actas where act_num like '%$actas%' AND per_consejo.per_consejo_id=actas.act_conid AND per_consejo.per_activo=1 and act_lb=$libro"; //query por defaul
	...
	//incia paginacion
					...
					$paging = new PHPPaging;
						...
						$mantenerURLVar = array('paginasok', 'hi','c1','c2','c3','lb'); 	
							...
							if($valida['estado']=='activo' )
							{
								...
								else
								{
									echo "<tr align=center>
											<td>".$f['act_num']."</td>
											<td>".$date_leer."</td>
											<td><a href=\"./m_registro_acuerdos_datos.php?id=$f[act_id]&lb=$select1\" target=\"_self\">agregar</a></td>
