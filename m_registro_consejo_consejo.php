...
$query_activo=mysql_query("SELECT * FROM per_consejo WHERE per_activo=1");

$valida=mysql_num_rows($query_activo);
if($valida==0)
{
	 $contenido="
 <form method=\"post\" enctype=\"application/x-www-form-urlencoded\" name=\"registo_consejo\" action=\"registro/procesa_consejo_periodo.php\" >
    	<table width=\"300\" border=\"0\" cellspacing=\"5\">
          <tr>
            ...
            <input type=\"text\" name=\"text1\" id=\"text5\" onclick=\"muestraCalendario('','registo_consejo','text1')\" style=\"cursor:pointer\" />
          ...
          <tr>
            ...
            <td><span id=\"sprytextfield2\">
              ...
              <input type=\"text\" name=\"text2\" id=\"text6\" onclick=\"muestraCalendario('','registo_consejo','text2')\" style=\"cursor:pointer\" />
              <span class=\"textfieldRequiredMsg\">*.</span></span></span></td>
          </tr>
          <tr>
...
{
	$contenido="<font color=\"#FF0000\">Ya Existe un Periodo Activo</font><br>";
}
...
<div id="menus">
 ...
 <li class="first" ><a href="inicio.php">Inicio</a></li>
   ...
   <li><a href="m_registro_personas.php">Personas</a></li>
    ...
    <li><a href="m_registro_actas_menu2.php.php">Actas</a></li>
...
<table width="350" border="0" cellspacing="5">
  <tr>
    <td align="center"><h2 >Registro del Periodo del Concejo</h2></td>
  </tr>
  <tr>
    <td align="center">
    <?php
