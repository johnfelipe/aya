...
<title>Nomina Elimacion de Observaciones</title>
</head>
	
<body>
	
    <h2 align="center">Nomina de Observaciones a Eliminar</h2>
    <table>
		...
		if(!empty($id))
		{
			...
			if($val_obs1 > 0)
			{
				...
				<tr>
					...
					<td>Salvedad</td>
					<td><input type=\"button\" nane='bx' value=\"Eliminar\"  onclick=\"open('obser_eliminar_datos.php?id1=".$row_obs1['ob1_id']."','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" ></td>
				<tr>
			...
			if($val_obs2 > 0)
			{
				...
				<tr>
					...
					<td><input type=\"button\" nane='bx' value=\"Eliminar\"  onclick=\"open('obser_eliminar_datos.php?id2=".$row_obs2['ob2_id']."','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" ></td>
				<tr>
			...
			if($val_obs3 > 0)
			{
				...
				<tr>
					...
					<td><input type=\"button\" nane='bx' value=\"Eliminar\"  onclick=\"open('obser_eliminar_datos.php?id3=".$row_obs3['ob3_id']."','per2','width=600, height=400, scrollbars=yes')\" style=\"cursor: pointer\" ></td>
				<tr>
