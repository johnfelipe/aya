...
if(isset($guardar))
{
	if(!empty($textarea1))
	{
		 if($e1=='sal')
		 {
			 ...
			 $sal_val=mysql_num_rows( mysql_query("select * from t_01"));
			 ...
			 else
			 {
				...
				if(mysql_query("INSERT INTO t_01 Values('','$textarea1')"))
				{
		 ...
		 elseif($e1=='abs')
		 {
			 $sal_val=mysql_num_rows( mysql_query("select * from t_02"));
			 ...
			 else
			 {
			 	...
			 	if(mysql_query("INSERT INTO t_02 Values('','$textarea1')"))
				{
		 ...
		 elseif($e1=='vot')
		 {
			 $sal_val=mysql_num_rows( mysql_query("select * from t_03"));
			 ...
			 if(mysql_query("INSERT INTO t_03 Values('','$textarea1')"))
				{
