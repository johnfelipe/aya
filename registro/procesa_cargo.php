...
if(isset($guardar))
{
 $query_nivel=mysql_query("SELECT * FROM cargo WHERE rango=$select1");
 $valor=mysql_num_rows($query_nivel);
...
else
{
	...
	if($update=mysql_query("INSERT INTO cargo VALUES('','$text1','$text2',$select1, $nivel)"))
	{
		$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Registro el cargo $text1')");
...
<meta http-equiv="refresh" content="1;URL=../m_manto_add_cargo.php"> 
<!-- InstanceEndEditable -->
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2  >Agrega Cargo</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
