...
//	echo $text1;
	...
	//echo $h1."_".$par0[1]."_".$par1[1]."_".$text4;
		...
		if(mysql_query("UPDATE per_consejo SET per_consejo_des='$date0', per_consejo_has='$date1' WHERE per_consejo_id=$h1"))
		{
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Actualizo los datos del Perido $text1 al $text2')");
