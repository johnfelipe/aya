...
if(isset($guardar))
{
		...
		if($insert=mysql_query("UPDATE cargo SET car_m='$text1', car_f='$text2'  WHERE car_id=$h1" ))
		{
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Actualizo los Datos del Cargo $text1')");
...
{
	header("location: ../m_manto_edit_cargos.php");
}
...
<meta http-equiv="refresh" content="2;URL=../m_manto_edit_cargos.php"> 
<!-- InstanceEndEditable -->
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2  >Edicion de Cargos</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
