...
if(isset($guardar))
{
	...
	echo $h1."_".$par0[1]."_".$par1[1]."_".$text4;
		...
		{
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Registro  a $par10] al cargo $par0[0] ')");
...
<meta http-equiv="refresh" content="1;URL=../m_manto_edit_cago.php"> 
<!-- InstanceEndEditable -->
