...
{
		$part=explode('+',$text1);
	if($update=mysql_query("INSERT INTO usuarios VALUES('',$part[1],'$text2',MD5('$password1'), 1,'$select1')"))
	{
		$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] registro al usuario \"$text2\" siendo el propietario $part[0]')");
...
<meta http-equiv="refresh" content="1;URL=../m_manto_add_usua.php"> 
<!-- InstanceEndEditable -->
...
<table width="295" border="0" align="center" background="">
  <tr>
    <td colspan="4" align="center"><h2>Bienvenido: </h2></td>
  </tr>
  <tr>
    ...
    <tr>
        ...
        name="des" value="Cerrar Session"   />      </td>
    </tr>
  </table>
</form>
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2  >Agrega Usuarios</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
