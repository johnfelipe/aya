...
if(isset($guardar))
{
	...
	{
		if($insert=mysql_query("UPDATE persona SET nombres='$text1', primer_apellido='$text2', segundo_apellido='$text3', id_genero='$s1', direccion='$textarea1', id_municipio='$par1[1]', telefono='$text4', dui='$text5', id_profesion=$par2[1], id_nacionalidad=$par3[1], imagen='$nom_foto' WHERE id_persona=$h1" ))
		{
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Actualizo los Datos de la Persona: $text1 $text2 Número de DUI $text5')");
		...
		{
			$mensaje.="
					<font color=\"#FF0000\">imposble Guardar los Datos1</font><br>";
		}
	...
	{
		if($insert=mysql_query("UPDATE personas SET nombres='$text1', primer_apellido='$text2', segundo_apellido='$text3', id_genero='$s1', direccion='$textarea1', id_municipio='$par1[1]', telefono='$text4', dui='$text5', id_profesion=$par2[1], id_nacionalidad=$par3[1] WHERE id_persona=$h1" ))
		{
			$mensaje="<h2>Datos Guardados</h2>
					<br>";
		}
		...
		{
			$mensaje.="
					<font color=\"#FF0000\">Imposble Actualizar los Datos</font><br>";
		}
...
<meta http-equiv="refresh" content="1;URL=../m_manto_edit_personas.php"> 
<!-- InstanceEndEditable -->
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2 >Edicion de Personas</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
