...
if(isset($guardar))
{
	...
	$par2=explode('+',$text2);
	$part=explode('-',$text3);
	$date1=$part[2]."-".$part[1]."-".$part[0];
	
		@$date2=$part2[2]."-".$part2[1]."-".$part2[0];
	
	
		if($insert=mysql_query("INSERT INTO empleados VALUES('', $par1[1],$par2[1],'$date1','$date2',1)"))
		{
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Registro al Empleado $par1[0] con el cargo de $par2[0]')");
...
<meta http-equiv="refresh" content="20;URL=../m_registro_empleados.php"> 
<!-- InstanceEndEditable -->
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2 >Registro de Empleados</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
