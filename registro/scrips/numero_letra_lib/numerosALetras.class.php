...
[php] include(ABSPATH.'/includes/numerosALetras.class.php'); /* Ahora puedes trabajar con la clase.  [/php]
    ...
    Creamos una instancia de la clase con un valor numérico, y mostramos el resultado. [php]$n = new numerosALetras(159); echo $n->resultado;[/php]

    Aquí el resultado:
    ciento cincuenta y nueve
    Ahora, lo mismo que el punto anterior, pero re-utilizando la instancia de la clase para convertir y mostrar otro valor. [php]$n = new numerosALetras(22); echo $n->resultado."
    "; echo $n->convertir(3.1416);[/php]

    Aquí el resultado:
    veinte y dos
    tres con catorce decimales
    En este último ejemplo traducimos una lista de valores, utilizando la misma instancia de la clase. [php]$n = new numerosALetras; echo $n->convertir(22)."
