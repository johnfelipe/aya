...
if(isset($id))
{
		...
		if($insert=mysql_query("UPDATE nomina_consejo SET  nomina_activo=1 WHERE nomina_id=$id" ))
		{
			...
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Activo el Cargo $row_cargo[car_m]')");
			$mensaje="<h2>Cargo Activado</h2>
					<br>";
		}
		else
		{
			$mensaje.="
					<font color=\"#FF0000\">Imposble Activar el Cargo</font><br>";
		}
