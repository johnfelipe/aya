...
if(isset($guardar))
{
	...
	//echo $par0[1];
  $con_cod=mysql_query("SELECT * FROM municipios WHERE id_dep='$par0[1]'");
  
  $numero_num=mysql_num_rows($con_cod);
  //echo "<br />".$numero_num;
  $numero=$numero_num+1;
  $codigo=$par0['1'].$numero;
		
		if(mysql_query("INSERT INTO municipios VALUES('$codigo','$text2','$par0[1]')"))
		{
			
			
			
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Registro al Municipio $text2 con código $codigo')");
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2 >Registro de Municipios</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
