...
if(isset($guardar))
{
		...
		if($insert=mysql_query("UPDATE usuarios SET  usu_usu='$text2', usu_pas=MD5('$password1'), usu_tip='$select1' WHERE usu_id=$h1" ))
		{
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Actualizo los datos del Usuario $text2')");
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2 >Edicion de usuarios</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
