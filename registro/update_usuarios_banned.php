...
if(isset($id))
{
		...
		if($insert=mysql_query("UPDATE usuarios SET  usua_ac=0 WHERE usu_id=$id" ))
		{
			$que=mysql_query("SELECT * FROM usuarios WHERE usu_id=$id");
			$row=mysql_fetch_array($que);
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Desactivo al Usuario $row[usu_usu]')");
			$mensaje="<h2>Usuario Desactivado</h2>
					<br>";
		}
		else
		{
			$mensaje.="
					<font color=\"#FF0000\">Usuario Desactivado</font><br>";
		}
