...
//echo fileperms ('../img/personas'); 
		...
		if($insert=mysql_query("truncate bitacora" ))
		{
			mysql_query("SET NAMES UTF8");
			$insert=mysql_query("INSERT INTO bitacora (text) VALUES('$_SESSION[name] Elimino la Bitácora')");
			$mensaje="<h2>Bitácora Eliminada</h2>
					<br>";
					session_destroy();
		}
		else
		{
			$mensaje.="
					<font color=\"#FF0000\">Imposble Eliminar</font><br>";
		}
...
<meta http-equiv="refresh" content="1;URL=../m_manto_repor_manto.php"> 
<!-- InstanceEndEditable -->
...
<div id="content">
    ...
    <div align="center" id="table1">
      <table width="200" border="0" cellspacing="5">
        <tr>
          <td align="center"><h2  >Manteminiento de Bitácora</h2></td>
          <td>&nbsp;</td>
          </tr>
        <tr>
          <td>
